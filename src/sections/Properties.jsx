...
import { FaBath, FaShareAlt, FaBed, FaUserCircle, FaVideo, FaCamera, FaMapMarkerAlt , FaHeart, FaPlus} from "react-icons/fa"
...
const  Properties = () => {
  ...
  return (
    <div className={`${darkMode ? 'dark bg-black' : 'light bg-transparent'}`}>
      <section id='properties' className='lg:w-[90%] m-auto ld:px-20 px-6 py-20 w-full flex flex-col justify-center items-start gap-10'>
        <div className='flex flex-col justify-center items-startgap-4'>
          <h1 data-aos="zoom-in" className='text-red-500 light:text-black'>PROPERTIES</h1>
          <h1 data-aos="zoom-in" className='text-black text-4xl font-semibold light:text-black'>  Expore the latest</h1>
        </div>

        {/* prperties grid start from here */}
            ...
            property.map((item, index) => (
              <div data-aos="zoom-in" data-aos-delay="200" key={index} className='bg-white dark:bg-gray-800 rounded-xl w-full'>
                ...
                <div className='px-6 py-3 flex flex-col justify-center items-start gap-2 w-full'>
                  ...
                  <h1 className='text-2xl text-red-600 font-bold light:text-white'>{item.price}</h1>
                  ...
                  <div id='owner-info' className='flex justify-between items-center w-full mt-2'>
                    ...
                    <div className='flex justify-center items-center gap-4'>
                      <div className='p-2 border-2 border-gray-200 hover:bg-black cursor-pointer transform hover:scall-110 transition-transform durartio-300'>
